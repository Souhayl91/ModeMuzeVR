    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public virtual void OnGripPressed(ControllerInteractionEventArgs e)
        {
            ...
            if (gripCounter == 4)
            {
                ...
                {
                    GameObject.Find("LocalAvatar").GetComponent<OvrAvatar>().ShowControllers(false);
                    if(GameObject.Find("ControllerTooltips") != null)
                    {
                        Destroy(GameObject.Find("ControllerTooltips"));
                    }
                }
            }
            if (GripPressed != null)
